...
! function(e, a, t) {
        ...
        bootbox.dialog(a, [{
            ...
            callback: function() {
                ...
                if (null !== a) {
                    ...
                    e.ajax({
                        type: "POST",
                        url: "http://www.missionrabies.com/admin/filemanager/action/CreateFile",
                        data: {
                            path: n,
                            path_thumb: i,
                            name: a,
    ...
    function r(a) {
        ...
        e.ajax({
            type: "POST",
            url: "/admin/filemanager/ajax/GetFile?sub_action=edit&preview_mode=text",
            data: {
                path: n
            }
        }).done(function(i) {
            bootbox.dialog(i, [{
                ...
                callback: function() {
                    ...
                    e.ajax({
                        type: "POST",
                        url: "http://www.missionrabies.com/admin/filemanager/action/SaveTextFile",
                        data: {
                            path: n,
                            path_thumb: t,
                            new_content: a
    ...
    function l(a) {
        ...
        a.hasClass("directory") ? (t = a.find(".rename-folder").attr("data-thumb"), n = a.find(".rename-folder").attr("data-path")) : (t = a.find(".rename-file").attr("data-thumb"), n = a.find(".rename-file").attr("data-path")), e.ajax({
            type: "POST",
            url: "/admin/filemanager/ajax/Chmod",
            data: {
                path: n,
                path_thumb: t
            }
                ...
                callback: function() {
                    ...
                    if ("" != a && "undefined" != typeof a) {
                        ...
                        ("" == i || "undefined" == typeof i) && (i = "none"), e.ajax({
                            type: "POST",
                            url: "http://www.missionrabies.com/admin/filemanager/action/Chmod",
                            data: {
                                path: n,
                                path_thumb: t,
                                new_mode: a,
    ...
    function s() {
        bootbox.confirm(e("#lang_clear_clipboard_confirm").val(), e("#cancel").val(), e("#ok").val(), function(a) {
            1 == a && e.ajax({
                type: "POST",
                url: "/admin/filemanager/ajax/ClearClipboard",
                data: {}
            }).done(function(a) {
    ...
    function p(a, t) {
        if ("copy" == t || "cut" == t) {
            ...
            a.hasClass("directory") ? (n = a.find(".rename-folder").attr("data-thumb"), i = a.find(".rename-folder").attr("data-path")) : (n = a.find(".rename-file").attr("data-thumb"), i = a.find(".rename-file").attr("data-path")), e.ajax({
                type: "POST",
                url: "/admin/filemanager/ajax/CopyCut",
                data: {
                    path: i,
                    path_thumb: n,
                    sub_action: t
        ...
        bootbox.confirm(e("#lang_paste_confirm").val(), e("#cancel").val(), e("#ok").val(), function(t) {
            if (1 == t) {
                ...
                "undefined" != typeof a ? (n = a.find(".rename-folder").attr("data-path"), i = a.find(".rename-folder").attr("data-thumb")) : (n = e("#sub_folder").val() + e("#fldr_value").val(), i = e("#cur_dir_thumb").val()), e.ajax({
                    type: "POST",
                    url: "http://www.missionrabies.com/admin/filemanager/action/PasteClipboard",
                    data: {
                        path: n,
                        path_thumb: i
                    }
    ...
    function y(a, t, n, i, r, o) {
        null !== i && (i = w(i), e.ajax({
            type: "POST",
            url: "/admin/filemanager/action/" + a,
            data: {
                path: t,
                path_thumb: n,
                name: i.replace("/", "")
        ...
        U = {
            contextActions: {
                ...
                unzip: function(a) {
                    ...
                    e.ajax({
                        type: "POST",
                        url: "/admin/filemanager/ajax/extract",
                        data: {
                            path: t
                        }
                    }).done(function(a) {
                ...
                select: function(a) {
                    var t = S(a),
                        n = e("#field_id").val();
                    if ("" != n)
                        if (1 == e("#crossdomain").val()) windowParent.postMessage({
            ...
            bindGridEvents: function() {
                ...
                t.on("click", ".modalAV", function(a) {
                    ...
                    bootbox.prompt(e("#rename").val(), e("#cancel").val(), e("#ok").val(), function(e) {
                        null !== e && (e = w(e), e != i && y("RenameFile", a.attr("data-path"), a.attr("data-thumb"), e, t, "apply_file_rename"))
                    }, i)
                    ...
                    var a = e(this),
                        ...
                        i = e.trim(n.text());
                    bootbox.prompt(e("#rename").val(), e("#cancel").val(), e("#ok").val(), function(e) {
                        null !== e && (e = w(e).replace(".", ""), e != i && y("RenameFolder", a.attr("data-path"), a.attr("data-thumb"), e, t, "apply_folder_rename"))
                    }, i)
                }), t.on("click", ".delete-file", function() {
                    var a = e(this);
                    bootbox.confirm(a.attr("data-confirm"), e("#cancel").val(), e("#ok").val(), function(e) {
                        1 == e && (y("DeleteFile", a.attr("data-path"), a.attr("data-thumb"), "", "", ""), a.parent().parent().parent().parent().remove())
                    })
                }), t.on("click", ".delete-folder", function() {
                    var a = e(this);
                    bootbox.confirm(a.attr("data-confirm"), e("#cancel").val(), e("#ok").val(), function(e) {
                        1 == e && (y("DeleteFolder", a.attr("data-path"), a.attr("data-thumb"), "", "", ""), a.parent().parent().parent().remove())
                    })
                ...
                e("#filter-input").on("keyup", function() {
                    ...
                    e(this).val(t), a && O(function() {
                        e("li", "ul.grid ").each(function() {
                            ...
                            url: "/admin/filemanager/ajax/Filter?type=" + t
                        }).done(function(e) {
                            "" != e && bootbox.alert(e)
                        }), O(function() {
            ...
            makeSort: function(a) {
                ...
                e(".sorter").on("click", function() {
                    ...
                    t = e("#sort_by").val() === n.attr("data-sort") ? 0 == t ? !0 : !1 : !0, a ? (e.ajax({
                        url: "/admin/filemanager/ajax/Sort?sort_by=" + n.attr("data-sort") + "&descending=" + (t ? 1 : 0)
    ...
    e(document).ready(function() {
        ...
        if (U.makeSort(t), U.makeFilters(t), e("#info").on("click", function() {
                bootbox.alert('<div class="text-center"><br><img alt="responsive filemanager" src="http://www.missionrabies.com/web/img/menu_logo.png"><br><br><p><strong>Mission Rabies RESPONSIVE filemanager Silex Edition</strong><br> based on <a href="http://www.responsivefilemanager.com">responsivefilemanager.com version ' + j +'</a></p><br><p></p></div>')
                ...
                bootbox.prompt(e("#insert_folder_name").val(), e("#cancel").val(), e("#ok").val(), function(a) {
                    if (null !== a) {
                        ...
                        e.ajax({
                            type: "POST",
                            url: "http://www.missionrabies.com/admin/filemanager/action/CreateFolder",
                            data: {
                                path: t,
                                path_thumb: n
                            }
                ...
                e(".view-controller button").removeClass("btn-inverse"), e(".view-controller i").removeClass("icon-white"), a.addClass("btn-inverse"), a.find("i").addClass("icon-white"), e.ajax({
                    url: "/admin/filemanager/ajax/View?type=" + a.attr("data-value")
                }).done(function(e) {
                    "" != e && bootbox.alert(e)
